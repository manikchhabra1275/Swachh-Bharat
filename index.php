...
<body style="background: linear-gradient(45deg, black,#5C6BC0);background-repeat:no-repeat;overflow-x:hidden;">
  ...
  <div class="container" >
    <div class="row top">
      ...
      <a href="#" data-activates="slide-out" class="button-collapse">
          <i class="material-icons animated bounceInLeft" style="color:teal">menu</i></a>
               
        
    </div>
         
    <div class="col s9 button" style="padding-left:55%">

       <a class="waves-effect waves-light btn btn-lg animated bounceInRight" href="sign_up.php">Sign up</a>
       <a class="waves-effect waves-light btn btn-lg animated bounceInRight" href="log_in.php">Log in</a>
    </div>
  ...
  <div class="row">
    <div class="col s12 card aboutus" style="background-color:transparent" >
        ...
        <h1 class="card-title" style="color:white;font-weight:900;font-size:50px;text-align: center">SWACHH BHARAT</h1><hr>
