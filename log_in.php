...
<body style="background: linear-gradient(45deg, black,#5C6BC0);background-repeat:no-repeat;overflow-x:hidden;">
  <div class="container">
    ...
    <div class="row images">
      <div class="col s6">
          <a href="log_in_user.php"><img  class="responsive-img user animated bounceInDown" src="img/user.png" ></a>
          <p style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;USER</p>
      </div>
      <div class="col s6">
          <a href="log_in_employee.php"><img  class="responsive-img employee animated bounceInDown" src="img/employee.png" ></a>
          <p style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EMPLOYEE</p>
      </div>
      <div>
